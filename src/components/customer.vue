  ...
  <div>
    ...
    <div style="display: inline">
      ...
      <el-input
        ...
        v-model="search"
        style="width: 200px"
        @keyup.enter.native="findCust"
      >
      </el-input>

      <!-- </el-col>
      </el-row> -->
      <el-button plain @click="findCust">搜尋</el-button>
      <el-button plain type="primary" @click="insertCust">新增</el-button>
      <el-button plain type="success" @click="findAllCust">顯示全部</el-button>
      <!-- <span style="margin-left: 500px"> 目前在:{{ pages }}頁</span> -->
    </div>

    <el-dialog title="新增客戶" :visible.sync="insertDialogVisible" width="50%">
      <!--內容主體區域-->
      <el-form
        :model="custForm"
        :rules="rules"
      ...
      >
        ...
        <el-form-item label="地址" prop="address">
          <el-input v-model="custForm.address" placeholder="地址"></el-input>
        </el-form-item>
        ...
        <el-form-item label="聯絡人" prop="contact">
          <el-input v-model="custForm.contact" placeholder="聯絡人"></el-input>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          type="primary"
          @click="submitForm('custForm')"
          @keypress.enter.native="submitEnter"
          >確 定</el-button
        >
...
export default {
  ...
  methods: {
        ...
        if (valid) {
          ...
          this.$axios({
            ...
            .then((a) => {
              ...
              this.$store.commit("addContents", a.data);
              // this.$store.commit("addSpec", a.data);
    ...
    findCust() {
      this.$store.dispatch("FIND_CUST_BYANY", this.search);
      this.search = "";
    },
    findAllCust() {
